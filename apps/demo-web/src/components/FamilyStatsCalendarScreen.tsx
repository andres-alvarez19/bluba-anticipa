      ...
      >
        ...
        <div className="grid grid-cols-7 gap-1">
          ...
          {monthDays.map((dayNum) => {
            ...
            const isHighRisk = record?.riskLevel === 'ELEVATED';
            const isModRisk = record?.riskLevel === 'MODERATE';
            ...
            <div className="flex items-center gap-1.5">
              <span
                className={`text-[10.5px] font-bold px-2 py-0.5 rounded-md ${
                  selectedDay.riskLevel === 'ELEVATED'
              ...
              >
                Riesgo {selectedDay.riskLabel} · Índice {selectedDay.riskScore}/100
              </span>
      ...
      >
        ...
        <div className="bg-slate-50 rounded-xl p-2.5 border border-slate-150 space-y-1">
          ...
          <p className="text-[11px] text-slate-600 leading-relaxed">
            <strong>Anticipación visual de transiciones</strong> es una estrategia previamente definida para Mateo.
          </p>
        </div>
      </section>
    </div>
