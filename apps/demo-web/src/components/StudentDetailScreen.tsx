...
export const StudentDetailScreen: React.FC<StudentDetailScreenProps> = ({
  ...
  const isHighRisk = student.riskLevel === 'ELEVATED';
  const isModerateRisk = student.riskLevel === 'MODERATE';
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-xs">
                  <div className="flex items-center justify-between gap-1">
                    ...
                    <span className="font-extrabold text-rose-700">{student.riskScore}/100</span>
                  </div>
                  <p className="text-[11px] text-slate-500 leading-snug">
                    {isHighRisk
                      ? 'Nivel preventivo elevado informado por el predictor.'
                      : isModerateRisk
                      ? 'Nivel preventivo moderado informado por el predictor.'
                      : 'Nivel preventivo bajo informado por el predictor.'}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 pt-1 border-t border-slate-200/60">
                ...
                <div className="text-xs">
                  <div className="flex items-center justify-between gap-1">
                    ...
                    <span className="font-extrabold text-sky-700">{student.confidenceScore}/100</span>
                  </div>
                  <p className="text-[11px] text-slate-500 leading-snug">
                    {student.confidenceLabel}. Se evalúa de forma independiente del nivel de riesgo.
                  </p>
                </div>
              </div>
            </div>
