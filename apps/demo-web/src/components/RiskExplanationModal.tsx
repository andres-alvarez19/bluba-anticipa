        ...
        <div className="p-4 space-y-4 overflow-y-auto text-xs text-slate-700 leading-relaxed">
          ...
          <div className="bg-amber-50 border border-amber-200/90 rounded-2xl p-3.5 flex items-center justify-between">
            <div>
              ...
              <span className="text-sm font-extrabold text-amber-950">
                {riskHeadline} {riskScore == null ? '' : `· Índice ${riskScore}/100`}
              </span>
            </div>
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-slate-600 pl-5">
              Es un <strong>índice preventivo operativo</strong> que resume señales longitudinales de Mateo. No representa una probabilidad clínica calibrada.
            </p>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              <div className="p-2.5 rounded-xl bg-emerald-50 border border-emerald-200/80 flex items-start gap-2">
                ...
                <div>
                  <span className="font-bold text-emerald-950 block text-[11px]">Bajo</span>
                  <span className="text-emerald-800 text-[10.5px]">Nivel entregado por el predictor para orientar seguimiento preventivo.</span>
                </div>
              </div>
              ...
              <div className="p-2.5 rounded-xl bg-amber-50 border border-amber-200/80 flex items-start gap-2">
                ...
                <div>
                  <span className="font-bold text-amber-950 block text-[11px]">Moderado</span>
                  <span className="text-amber-800 text-[10.5px]">Nivel entregado por el predictor; conviene revisar sus factores trazables.</span>
                </div>
              </div>
              ...
              <div className="p-2.5 rounded-xl bg-rose-50 border border-rose-200/80 flex items-start gap-2">
                ...
                <div>
                  <span className="font-bold text-rose-950 block text-[11px]">Elevado</span>
                  <span className="text-rose-800 text-[10.5px]">Señales preventivas elevadas; considerar el protocolo profesional acordado.</span>
                </div>
              </div>
            </div>
          </div>
