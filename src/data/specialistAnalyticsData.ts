...
export const MATEO_LONGITUDINAL_DATA: Record<TimeWindow, LongitudinalMetrics> = {
  '72h': {
    ...
    regulationRecentDays: [
      ...
      { dayLabel: 'Hoy', value: 56, status: 'Desviación -28%' },
    ],
  ...
  '24h': {
    ...
    regulationBaseline: 78,
    regulationRecentDays: [
      { dayLabel: 'Registro matutino', value: 56, status: 'Desviación -28%' },
    ],
    regulationCurrentDiffPercent: -28,
    wakeupBaselineLabel: 'Tranquilo · Disposición estándar',
    wakeupRecentDays: [
  ...
  '7d': {
    ...
    regulationRecentDays: [
      ...
      { dayLabel: 'Hoy', value: 56, status: '-28%' },
    ],
    regulationCurrentDiffPercent: -28,
    wakeupBaselineLabel: 'Tranquilo · Disposición estándar',
    wakeupRecentDays: [
...
export const MATEO_ACCUMULATIONS: AccumulationCardItem[] = [
  ...
  },
  {
    ...
    description: 'Tendencia a la baja sostenida en check-ins de hogar (-28 % acumulado).',
    severity: 'high',
  },
  {
    id: 'acc-3',
...
export const MATEO_FACTORS_RANKING: FactorRankingItem[] = [
  ...
  },
  {
    ...
    evidenceSummary: 'Capacidad de autorregulación matutina reducida en un 28 % respecto a su media.',
    baselineComparison: 'Baseline habitual: 78 pts | Registro matutino: 56 pts (-28 %)',
    details: {
