...
export const MATEO_ACTIVE_CASE: ChildState = {
  ...
  riskLevel: 'ELEVATED',
  riskScoreInternal: 74,
  riskTextHeadline: 'RIESGO ELEVADO',
  riskSubtext: 'Mayor atención preventiva recomendada durante las próximas 24 horas.',
  
  confidenceLevel: 'MEDIUM',
  confidenceScoreInternal: 67,
  confidenceHeadline: 'CONFIANZA MEDIA',
  confidenceAuxText: 'La información disponible permite realizar una estimación, aunque todavía falta un registro relevante.',
  ...
  factors: [
    {
      ...
      categoryLabel: 'Acumulación',
      iconType: 'sleep',
      baselineComparison: {
        baselineLabel: 'Sueño habitual',
        baselineValue: '7,8 h',
        currentLabel: 'Últimos 3 días',
        currentValue: '~6 h (hoy 5,9 h)'
      },
      explanation: '3 noches consecutivas por debajo de su umbral reparador. La fatiga acumulada disminuye progresivamente su ventana de tolerancia.',
      trendDetail: 'D-3: 6,3 h • D-2: 6,0 h • Hoy: 5,9 h'
    },
    {
      id: 'f-reg',
      title: 'Regulación inferior a su patrón habitual',
      category: 'DESVIACION',
      categoryLabel: 'Desviación',
      iconType: 'regulation',
      baselineComparison: {
        baselineLabel: 'Patrón habitual',
        baselineValue: 'Estable',
        currentLabel: 'Tendencia actual',
        currentValue: 'Descendente'
      },
      explanation: 'Se registra menor capacidad de autorregulación matutina y mayor irritabilidad ante pequeños estímulos sonoros.',
      trendDetail: 'Despertar con menor fluidez de transición'
    },
    {
      id: 'f-routine',
      title: 'Cambio reciente de rutina escolar',
      category: 'CONTEXTO',
      categoryLabel: 'Contexto',
      iconType: 'routine',
      baselineComparison: {
        baselineLabel: 'Entorno habitual',
        baselineValue: 'Sala A (familiar)',
        currentLabel: 'Modificación',
        currentValue: 'Cambio de sala escolar'
      },
      explanation: 'Cambio de aula y personal de apoyo notificado ayer por la institución, factor contextual de alta demanda adaptativa.',
      trendDetail: 'Reportado ayer en comunicación escolar'
    }
  ],
  ...
  missingData: [
    {
      id: 'm-school',
      name: 'Regulación en el colegio hoy',
      status: 'pending',
      source: 'Equipo escolar',
      impactNote: 'Afecta la confianza de la estimación (se mantiene en Media), no altera el riesgo ya identificado en casa.'
    }
  ],
  ...
  preventiveAction: {
    ...
    tipsForCaregiver: 'En episodios previos de sueño <6h, la anticipación visual redujo un 70% las desregulaciones vespertinas.'
  },
  
  recentHistorySummary: {
    dayMinus3: { sleep: 6.3, regulation: 'Estable con leves roces' },
    dayMinus2: { sleep: 6.0, regulation: 'Baja tolerancia a la frustración' },
    today: { sleep: 5.9, regulation: 'Descendente', schoolChange: true }
  }
};
