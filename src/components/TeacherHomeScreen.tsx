...
export const TeacherHomeScreen: React.FC<TeacherHomeScreenProps> = ({
  ...
  // Filter and order students:
  // 1st student: recent change ("Nuevo cambio") - Martín C. (65% risk, 80% confidence)
  // 2nd student: desregulation alert ("Alerta de desregulación") - Mateo R. (78% risk, 85% confidence)
  const desregulatedStudents: ClassroomStudent[] = [
    {
      id: 'martin-c',
      name: 'Martín C.',
      initials: 'MC',
      ...
      riskLevel: 'MODERATE',
      riskBadgeLabel: 'Nuevo cambio',
      attentionHeadline: 'Nuevo cambio',
      summaryReason: 'Aumento de agitación motora al regresar del recreo.',
      updatedTime: 'Hace 10 min',
      considerations: [
        'Cambio reciente tras recreo de las 11:30.',
        'Mayor inquietud motora e interrupciones en aula.',
      ],
      classroomActions: [
        {
          id: 'action-mc-1',
          number: 1,
          title: 'Asignar rol de ayuda en distribución de materiales',
          description: 'Canalización motora durante la transición'
        }
      ]
    },
    {
      ...
      confidenceLabel: 'Alta',
      riskLevel: 'ELEVATED',
      riskBadgeLabel: 'Alerta de desregulación',
      attentionHeadline: 'Alerta de desregulación',
      summaryReason: 'Sensibilidad acusada por ruido y cambio de sala programado.',
      updatedTime: 'Hace 35 min',
      considerations: [
        'Déficit acumulado de sueño reportado desde el hogar.',
        'Mayor irritabilidad ante transiciones ruidosas.',
      ],
      classroomActions: [
        {
          id: 'action-mr-1',
          number: 1,
          title: 'Anticipar cambio de sala 10 minutos antes con panel visual',
          description: 'Anticipación y apoyo visual antes del timbre'
        }
      ]
    }
  ];
